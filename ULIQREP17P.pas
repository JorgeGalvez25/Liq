...
procedure TFLIQREP17P.BOpcionesClick(Sender: TObject);
begin
  PrintDialog1.Execute;
end;

procedure TFLIQREP17P.FormShow(Sender: TObject);
begin
...
procedure TFLIQREP17P.BCancelarClick(Sender: TObject);
begin
  Close;
end;

procedure TFLIQREP17P.BImprimirClick(Sender: TObject);
begin
...
procedure TFLIQREP17P.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if PrinterActiva then
    Printer.PrinterIndex:=PredPrinter1;
end;

procedure TFLIQREP17P.ComboBox1Change(Sender: TObject);
begin
  if PrinterActiva then
    Printer.PrinterIndex:=ComboBox1.ItemIndex;
end;

procedure TFLIQREP17P.MaskEdit3Exit(Sender: TObject);
begin
  VgFechaIni:=StrToDate(MaskEdit3.text);

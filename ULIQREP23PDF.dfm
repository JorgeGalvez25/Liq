object FLIQREP23PDF: TFLIQREP23PDF
  Left = 302
  Top = 198
  Width = 894
  Height = 406
  ...
  object QL_Pval: TQuery
    ...
    SQL.Strings = (
        ...
        'Select Cliente,fecha, turno, total, Estacion, Caja, Indice from ' +
        'DGASPVAL'
  ...
  object QL_Vale: TQuery
    ...
    SQL.Strings = (
      ...
      '   and Caja=:Caja'
      '   and Indice=:Indice  and facturado='#39'No'#39
      'Order by Fecha')
    Left = 120
    Top = 8
    ParamData = <
  ...
  object QL_Dval: TQuery
    ...
    SQL.Strings = (
      ...
      'Turno=:turno and'
      'Indice=:indice and'
      'IndiceVale=:IndiceVale and facturado='#39'No'#39)
    Left = 222
    Top = 7
    ParamData = <
      item

object FLIQTURCVI: TFLIQTURCVI
  ...
  object QL_Dval: TQuery
    ...
    SQL.Strings = (
        ...
        'Select IndiceVale,Producto,subclave,Fecha,Importe,Cantidad  from' +
        ' DGASDVAL'
  ...
  object QL_Dval3: TQuery
    ...
    object QL_Dval3PRODUCTO: TIntegerField
      FieldName = 'PRODUCTO'
    end
    object QL_Dval3TOTAL: TFloatField
      FieldName = 'TOTAL'
    end
    object QL_Dval3NombreProducto: TStringField
      FieldKind = fkLookup
      FieldName = 'NombreProducto'
      LookupDataSet = DMGAS.T_Tcmb
      LookupKeyFields = 'CLAVE'

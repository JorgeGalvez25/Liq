object FLIQREP40: TFLIQREP40
  Left = 207
  Top = 149
  Width = 1036
  Height = 473
  HorzScrollBar.Position = 28
  Caption = 'Reporte de Ventas en Litros Multiestaci'#243'n '
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object ChBEnca: TQRChildBand
      ...
      object QRLabel7: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Estaci'#243'n Liquidada'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object QL_Ajusd2: TQuery
    ...
    SQL.Strings = (
        ...
        'select d.estacion, (select e.Nombre from DGASESTS e where e.clav' +
        'e=d.estacion),'
      'd.combustible,Sum(d.volumen) from dgasajud2 d')
    Left = 223
    Top = 207
    ...
    object QL_Ajusd2Nombre: TStringField
      FieldName = 'Nombre'
    end
  end
  ...
  object TM_AuxiR: TRxMemoryData
    ...
    Left = 150
    Top = 297
    object TM_AuxiREstacion: TIntegerField
      FieldName = 'Estacion'
    end
    ...
    object TM_AuxiRNombre: TStringField
      FieldName = 'Nombre'
    end
    object TM_AuxiRLiquidado: TStringField
      FieldName = 'Liquidado'
      Size = 2
    end
  end

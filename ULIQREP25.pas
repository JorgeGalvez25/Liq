...
procedure TFLIQREP25.CreaEtiquetas;
var i,xl,xw:integer;
begin
  xl:=xLeft;
...
procedure TFLIQREP25.PreparaReporte;
var totc,totg:real;
    xcliente:integer;
begin
  with DMGEN,DMLIQ,DMGEN_VTAS,DMGAS,FLIQREP23P do begin
    ...
    try
      ...
      while not QL_Pval.Eof do begin
        ...
        xlin:='E//'+IntToClaveNum(QL_PvalCliente.AsInteger,5)+' '+QL_PvalNombre.AsString;
...
procedure TFLIQREP25.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TFLIQREP25.BndDtBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
procedure TFLIQREP25.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand:=xtp in ['B','T'];
end;

procedure TFLIQREP25.FormDestroy(Sender: TObject);
begin
  QL_Pval.Close;
  QL_Vale.Close;
  QL_Dval.Close;
...
procedure TFLIQREP25.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TFLIQREP25.QL_ValeCalcFields(DataSet: TDataSet);
begin

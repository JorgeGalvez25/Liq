...
uses ULIBGRAL, DDMGEN, UGEN_NET, ULIBDATABASE, ULIBPRINT,  DDMCFG, DDMGAS, ULIQREP10,
  DDMLIQ;

{$R *.DFM}

procedure TFLIQREP10P.PreparaForma(xModo:integer);
begin
  ModoRep:=xModo;
end;
...
begin
  with DMGEN,DMCFG do begin
    ...
    try
      FLIQREP10.PreparaReporte(ModoRep);
...
procedure TFLIQREP10P.DBLookupComboBox2Enter(Sender: TObject);
begin

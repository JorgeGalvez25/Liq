object FLIQREP33: TFLIQREP33
  Left = 212
  Top = 176
  Width = 887
  Height = 370
  VertScrollBar.Position = 8
  Caption = 'Reporte de Comisiones por Despachador'
  Color = clBtnFace
  ...
  object QL_Dliqa: TQuery
    ...
    SQL.Strings = (
        ...
        'Select a.Estacion,a.Fecha,a.Folio,a.Producto,a.Venta,a.Precio_Ci' +
        'va,a.Importe,'
      
        '  (Select d.Despachador from DGASLIQG d where d.Estacion=a.Estac' +
        'ion and d.Folio=a.folio) as Desp,'
      
        '  (select p.Comision from DGASPROD p where p.clave=a.producto) a' +
        's Comision,'
      '  a.isla,a.turno'
      'from DGASDLIQA a'
      'Order by a.Estacion, a.Folio, a.Fecha')
    Left = 24
    Top = 8
    ...
    object QL_DliqaCOMISION: TFloatField
      FieldName = 'COMISION'
    end
  end
  object TT_Auxi: TTable
    ...
    object TT_AuxiPorcComision: TFloatField
      FieldName = 'PorcComision'
    end
    object TT_AuxiComision: TFloatField
      FieldName = 'Comision'
    end
  end

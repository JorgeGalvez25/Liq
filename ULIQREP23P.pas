...
procedure TFLIQREP23P.BOpcionesClick(Sender: TObject);
begin
  PrintDialog1.Execute;
end;

procedure TFLIQREP23P.FormShow(Sender: TObject);
begin
...
procedure TFLIQREP23P.BCancelarClick(Sender: TObject);
begin
  Close;
end;

procedure TFLIQREP23P.BImprimirClick(Sender: TObject);
begin
...
procedure TFLIQREP23P.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if PrinterActiva then
    Printer.PrinterIndex:=PredPrinter1;
end;

procedure TFLIQREP23P.ComboBox1Change(Sender: TObject);
begin
  if PrinterActiva then
    Printer.PrinterIndex:=ComboBox1.ItemIndex;
end;

procedure TFLIQREP23P.CheckBox3Click(Sender: TObject);
begin
  DBLookUpComboBox3.Enabled:=not CheckBox3.Checked;
end;

procedure TFLIQREP23P.MaskEdit3Exit(Sender: TObject);
begin
  VgFechaIni:=StrToDate(MaskEdit3.text);
  MaskEdit4.Text:=FechaToFormato(DiaUltimo(VgFechaIni));
end;

procedure TFLIQREP23P.DBLookupComboBox2Enter(Sender: TObject);
begin

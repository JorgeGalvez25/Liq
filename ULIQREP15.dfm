object FLIQREP15: TFLIQREP15
  Left = 212
  Top = 176
  Width = 544
  Height = 376
  VertScrollBar.Position = 8
  Caption = 'Reporte de Faltantes y Sobrantes'
  Color = clBtnFace
  ...
  object QL_Dliqp: TQuery
    ...
    SQL.Strings = (
      ...
      '          (Select Despachador from DGASLIQG'
      
        '           Where Estacion=DGASDLIQP.Estacion and Folio=DGASDLIQP' +
        '.Folio) as Despachador'
      ' from DGASDLIQP'
      'Where Estacion=:pestacion and '
      '            Fecha>=:pfechaini and Fecha<=:pfechafin and'
      '            abs(Importe)>0.001 and'
      '            Clave_Pago=:pclave_Pago'
      'Order by Estacion,Folio')
    Left = 40
    Top = 8
    ParamData = <
      item
  ...
  object QL_Tpa: TQuery
    DatabaseName = 'DBGASOL1'
    SQL.Strings = (
      'Select Clave from DGASTPAG'
      'Where Clase='#39'Faltantes'#39)
    Left = 112
    Top = 8
    object QL_TpaCLAVE: TStringField
      FieldName = 'CLAVE'
      Size = 2
    end
  end
  ...
  object TT_Auxi: TRxMemoryData
    ...
    object TT_AuxiClave: TIntegerField
      FieldName = 'Clave'
    end
    ...
    object TT_AuxiFaltante: TFloatField
      FieldName = 'Faltante'
    end
    object TT_AuxiSobrante: TFloatField
      FieldName = 'Sobrante'
    end
    ...
    object TT_AuxiDiferencia: TFloatField

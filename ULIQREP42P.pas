...
procedure TFLIQREP42P.MaskEdit2Enter(Sender: TObject);
begin
...
procedure TFLIQREP42P.MaskEdit2Exit(Sender: TObject);
begin
...
procedure TFLIQREP42P.MaskEdit2DblClick(Sender: TObject);
begin
...
procedure TFLIQREP42P.CheckBox1Click(Sender: TObject);
begin
  DBLookupComboBox2.Enabled:=not CheckBox1.Checked;
end;

procedure TFLIQREP42P.FormShow(Sender: TObject);
begin
...
procedure TFLIQREP42P.BCancelarClick(Sender: TObject);
begin
  Close;
end;

procedure TFLIQREP42P.BPreverClick(Sender: TObject);
begin
  ...
  try
    FLIQREP42.PreparaReporte;
    if sender=BImprimir then
      FLIQREP42.QuickRep1.Print
    else
      FLIQREP42.QuickRep1.Preview;
  finally
    FLIQREP42.Free;
  end;
end;

procedure TFLIQREP42P.CheckBox2Click(Sender: TObject);
begin
  MaskEdit2.Enabled:=not CheckBox2.Checked;
end;

procedure TFLIQREP42P.MaskEdit2KeyPress(Sender: TObject; var Key: Char);
begin
  if not (key in['0'..'9',#8]) then
    Key:=#0;
end;

procedure TFLIQREP42P.DateTimePicker1Exit(Sender: TObject);
begin
  VgFechaIni:=DateTimePicker1.DateTime;

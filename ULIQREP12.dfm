object FLIQREP12: TFLIQREP12
  Left = 375
  Top = 188
  Width = 803
  Height = 370
  VertScrollBar.Position = 8
  Caption = 'Reporte de Saldos Reales de Clientes'
  Color = clBtnFace
  ...
  object QL_Pval: TQuery
    ...
    SQL.Strings = (
      'Select Cliente,Sum(Total) as Total from DGASPVAL'
      'where Facturado='#39'No'#39' and fecha<=:pfechafin'
      'and estacion=:pestacion'
      'Group by Cliente'
      'Order by Cliente')
    Left = 32
    Top = 16
  ...
  object QL_Tran: TQuery
    DatabaseName = 'DBGASOL1'
    SQL.Strings = (
      'Select Cliente,Sum(Total) as Total from DGASTRAN'
  ...
  object TT_Auxi: TRxMemoryData
    ...
    object TT_AuxiSaldoCXC: TFloatField
      FieldName = 'SaldoCXC'
    end
    object TT_AuxiVales: TFloatField
      FieldName = 'Vales'
    end
    object TT_AuxiTarjetas: TFloatField
      FieldName = 'Tarjetas'
    end
    ...
    object TT_AuxiLimiteCredito: TFloatField
      FieldName = 'LimiteCredito'
    end
    object TT_AuxiTotalAdeudo: TFloatField
      FieldName = 'TotalAdeudo'
    end
    object TT_AuxiDisponible: TFloatField
  ...
  object QL_Clie: TQuery
    ...
    SQL.Strings = (
      ...
      'where NoClie in (Select NoClie from DCXCSCXC)'
      'Order by NoClie')
    Left = 136
    Top = 8
  ...
  object QL_Sald: TQuery
    DatabaseName = 'DBGASOL1'
    SQL.Strings = (
      'Select NoClie,LimiteCredito, AdeudoVales from DGASSALD'
      'where TipoTarjeta='#39'CR'#39
      'Order by NoClie')
    Left = 241
    Top = 224
    object QL_SaldNOCLIE: TIntegerField
      FieldName = 'NOCLIE'
    end
    object QL_SaldLIMITECREDITO: TFloatField
      FieldName = 'LIMITECREDITO'
    end
    object QL_SaldADEUDOVALES: TFloatField
      FieldName = 'ADEUDOVALES'
    end
  end
end

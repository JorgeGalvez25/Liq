object FLIQLIQGI1: TFLIQLIQGI1
  Left = 214
  Top = 160
  Width = 544
  Height = 376
  VertScrollBar.Position = 8
  Caption = 'Resumen de Turno'
  Color = clBtnFace
  ...
  object QL_Dliqc: TQuery
    ...
    SQL.Strings = (
        ...
        'd,sum(importe) as Importe from dgasdliqc'
  ...
  object QL_Dliqp: TQuery
    ...
    SQL.Strings = (
        ...
        'Select estacion,fecha,turno,combustible,sum(Cantidad),sum(import' +
        'e) from dgasdliqc'
      'group by estacion,fecha,combustible'
      'having (estacion=1) and (fecha='#39'05/13/2003'#39') and (turno=1)'
      'order by combustible')
    Left = 120
    Top = 16
  end

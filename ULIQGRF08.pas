...
var
  FLIQGRF08: TFLIQGRF08;

implementation

uses ULIQGRF08P, ULIBGRAL, ULIBDATABASE, Printers, DDMGAS, UAVANCE;

{$R *.dfm}

procedure TFLIQGRF08.PreparaForma(xModo:Integer; swAnio:string);
var
  estacion:word;
...
begin
  ...
  if xModo=1 then
    Chart1.Title.Text.Add('Comparativo de ventas en litros de combustible*')
  else
    Chart1.Title.Text.Add('Comparativo de ventas en litros de combustible');
  if not FLIQGRF08P.GBMes.Visible then begin
  ...
  with FLIQGRF08P, DMGAS do begin
...
procedure TFLIQGRF08.ActionSalirExecute(Sender: TObject);
begin
  Close;
end;

procedure TFLIQGRF08.DesactivarCantidades1Click(Sender: TObject);
begin
  Series1.Marks.Visible := not Series1.Marks.Visible;
  Series2.Marks.Visible := not Series2.Marks.Visible;
end;

procedure TFLIQGRF08.PopupMenuDesCantPopup(Sender: TObject);
begin
...
procedure TFLIQGRF08.BitBtn1Click(Sender: TObject);
begin

...
procedure TFLIQGRF05.PreparaForma(xModo:integer);
var
...
begin
  ...
  if xModo=1 then //03-12-15
    Chart1.Title.Text.Add('Ventas en importes de combustibles y aceites por estación*')
  else
    Chart1.Title.Text.Add('Ventas en importes de combustibles y aceites por estación');
  for i:= 1 to 10 do
    xEstaciones[i]:=0;
...
//    estacion:=DBLookupComboBox2.KeyValue;
    ...
    Q_Auxi.SQL.Clear;
    Q_Auxi.SQL.Add('Select c.Estacion as Entero1, sum(c.Importe) as Real1,');
    if GBFecha.Visible then begin
      ...
      QL_AjusM.Close;
      QL_AjusM.SQL.Clear;
      QL_AjusM.SQL.Add('select estacion, sum(coalesce(Total,0)) as Total,');
      ...
      QL_AjusA.Close;
      QL_AjusA.SQL.Clear;
      QL_AjusA.SQL.Add('select estacion,sum(coalesce(Total,0)) as Total,');
    ...
    if GBFecha.Visible then
      ...
      QL_AjusM.SQL.Add('group by anio,Mes,estacion');
      QL_AjusM.Prepare;
      QL_AjusM.Open;
    end
    else begin
      Q_Auxi.SQL.Add(' group by Entero2,Entero1');
      QL_AjusA.SQL.Add('group by estacion,Anio');
      QL_AjusA.Prepare;
      QL_AjusA.Open;
    end;
    Q_Auxi.Prepare;
    ...
    while not Q_Auxi.Eof do begin
      ...
      if GBFecha.Visible then begin
        ...
        if xModo=0 then begin
          try
            if QL_AjusM.Locate('Anio;Mes;estacion',VarArrayOf([Q_AuxiEntero3.AsInteger,Q_AuxiEntero2.AsInteger,Q_AuxiEntero1.AsInteger]),[]) then
        ...
        try
          ...
          Q_Auxi2.SQL.Add('  and a.estacion='+IntToStr(Q_AuxiEntero1.AsInteger));
          Q_Auxi2.SQL.Add('  and exists(select m.* from dgasliqg m where m.estacion=a.estacion and m.folio=a.folio and m.aplicado='+Quotedstr('Si')+')');
          Q_Auxi2.Prepare;
          Q_Auxi2.Open;
          xVta:=xVta+Q_Auxi2Real1.AsFloat;
        ...
        if Q_AuxiEntero1.AsInteger=1 then begin
          Series1.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
        else if Q_AuxiEntero1.AsInteger=2 then begin
          Series2.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
        else if Q_AuxiEntero1.AsInteger=3 then begin
          Series3.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
        else if Q_AuxiEntero1.AsInteger=4 then begin
          Series4.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
        else if Q_AuxiEntero1.AsInteger=7 then begin
          Series5.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
        else if Q_AuxiEntero1.AsInteger=8 then begin
          Series6.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
        else if Q_AuxiEntero1.AsInteger=9 then begin
          Series7.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
        else if Q_AuxiEntero1.AsInteger=10 then begin
          Series8.AddXY(j{Q_AuxiEntero2.AsInteger},{Q_AuxiReal1.AsFloat}xVta,DameMes(Q_AuxiEntero2.AsInteger)+IntToStr(Q_AuxiEntero3.AsInteger));
        end
      end
      else begin
        if xModo=0 then begin
...
//      xLtsTotales:= xLtsTotales+Total-xVtaAju;
    ...
    Chart1.LeftAxis.Maximum := TotalMayor+1000;
    Q_Auxi2.Close;
    Q_Auxi.Close;
//    if not CBTodas.Checked then
...
procedure TFLIQGRF05.ActionSalirExecute(Sender: TObject);
begin
  Close;
end;

procedure TFLIQGRF05.DesactivarCantidades1Click(Sender: TObject);
begin
...
procedure TFLIQGRF05.PopupMenuDesCantPopup(Sender: TObject);
begin
...
procedure TFLIQGRF05.Impresora1Click(Sender: TObject);
begin
